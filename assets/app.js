...
function autoGenerateDocumentNumbers() {
    ...
    const baseCode = `TD${String(d.getFullYear()).slice(-2)}${String(d.getMonth() + 1).padStart(2, '0')}${String(d.getDate()).padStart(2, '0')}`;
    ...
    if(document.getElementById('contractNo')) document.getElementById('contractNo').value = `${baseCode}-${nextSuffix}-HD`;
}
