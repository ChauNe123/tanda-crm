    ...
    return `
        <div id="quote-section" class="pdf-quote pb-[10mm]">
            <table class="quote-header"><tr><td style="width: 20%; vertical-align: middle; padding: 0;">
                <div style="font-size: 38px; font-weight: 800; letter-spacing: -0.05em; line-height: 1; color: #1e293b;">
    TAN<span style="color: #f97316;">DA</span>
</div>
            </td><td style="width: 45%; vertical-align: middle; padding: 0 0 0 15px;"><div style="font-size: 12.5pt; font-weight: 800; color: #1e293b; letter-spacing: 0.5px; text-transform: uppercase;">CÔNG TY TNHH TM DV TANDA</div><div style="font-size: 9.5pt; color: #64748b; margin-top: 5px; line-height: 1.5;">info@tanda.vn | 0933 129 155<br>341/25S Lạc Long Quân, P.Hoà Bình, TP.HCM</div></td><td style="width: 35%; text-align: right; vertical-align: middle; padding: 0;"><div class="quote-title">BÁO GIÁ</div><div class="quote-subtitle">Quotation Proposal</div><div style="margin-top: 8px; font-size: 10pt; color: #64748b;">Mã số / No: <span style="font-weight: 700; color: #b30000; font-family: 'JetBrains Mono', monospace; font-size: 11pt;">${docData.qNo}</span></div></td></tr></table>
            <table class="quote-meta-grid"><tr><td style="width: 42%; padding-right: 20px;"><div class="quote-label">Đơn vị tiếp nhận <span class="quote-muted">/ To</span></div><div class="quote-value"><strong class="quote-accent" style="font-size: 11.5pt;">${docData.bName}</strong><br><span style="font-size: 9.5pt; font-weight: 400; color: #475569; display: block; margin-top: 6px;">Đại diện: <strong style="color: #1e293b;">${docData.bRep}</strong><br>SĐT: ${docData.bPhone}<br>Đ/C: ${docData.bAddress}</span></div></td><td style="width: 33%; padding-right: 15px;"><div class="quote-label" style="padding-left: 12px;">Tư vấn dự án <span class="quote-muted">/ From</span></div><div class="quote-value" style="border-left: 2px solid #e2e8f0; padding-left: 10px;"><strong style="color: #1e293b;">${docData.safeFullName}</strong><br><span style="font-size: 9.5pt; font-weight: 400; color: #475569; display: block; margin-top: 4px;">${docData.safePhone}<br>${docData.safeEmail}</span></div></td><td style="width: 25%;"><div class="quote-label">Thông tin <span class="quote-muted">/ Info</span></div><div class="quote-value"><table style="width: 100%; border-collapse: collapse; font-size: 9.5pt; font-weight: 400; color: #475569;"><tr><td style="padding: 0 0 5px 0; width: 45px;">Ngày</td><td style="padding: 0 5px 5px 0; width: 10px;">:</td><td style="padding: 0 0 5px 0; font-weight: 600; color: #1e293b;">${docData.pdfDateStr}</td></tr><tr><td style="padding: 0 0 5px 0;">HSD</td><td style="padding: 0 5px 5px 0;">:</td><td style="padding: 0 0 5px 0;">07 Ngày</td></tr><tr><td style="padding: 0; vertical-align: top;">Dự án</td><td style="padding: 0 5px 0 0; vertical-align: top;">:</td><td style="padding: 0; font-weight: 600; color: #b30000; line-height: 1.3;">${docData.pName}</td></tr></table></div></td></tr></table>
