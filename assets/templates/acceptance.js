    ...
    return `
        <div id="acceptance-section" class="doc-wrapper" style="position: relative;">
            <div class="content-wrapper" contenteditable="true" style="outline: none;">
                ...
                <p style="margin-top: 10px;"><b><u>BÊN GIAO (BÊN B)</u> : CÔNG TY TNHH THƯƠNG MẠI DỊCH VỤ TANDA</b></p><p>Đại diện: <b>Ông/Bà ${docData.safeFullName}</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Chức vụ: ${docData.safeRole}</p>
