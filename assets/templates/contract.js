function generateContractHTML(docData, products, formatMoney) {
    ...
    let paymentText = docData.payOpt === "50" 
        ? `<p>- <b>Đợt 1:</b> Bên A thanh toán <b>50%</b> giá trị hợp đồng (tương đương <b>${formatMoney(docData.grandTotal/2)} </b>) ngay sau khi ký kết Hợp đồng để Bên B tiến hành chuẩn bị hàng hóa.</p><p>- <b>Đợt 2:</b> Bên A thanh toán <b>50%</b> giá trị còn lại (tương đương <b>${formatMoney(docData.grandTotal/2)} </b>) sau khi Bên B hoàn tất giao hàng, lắp đặt và bàn giao hệ thống (nếu có).</p>` 
        : `<p>- Bên A thanh toán <b>100%</b> giá trị hợp đồng (tương đương <b>${formatMoney(docData.grandTotal)} </b>) ngay sau khi ký kết Hợp đồng để Bên B tiến hành chuẩn bị và giao hàng.</p>`;
    ...
    return `
        <div id="contract-section" class="doc-wrapper" style="position: relative;">
            <div class="content-wrapper" contenteditable="true" style="outline: none;">
                ...
                <div style="margin-bottom: 15px;"><p><b><u>BÊN BÁN (Bên B)</u> : CÔNG TY TNHH THƯƠNG MẠI DỊCH VỤ TANDA</b></p><table style="border: none; width: 100%; margin: 0;"><tr><td style="border: none; padding: 2px; width: 120px;">Địa chỉ</td><td style="border: none; padding: 2px;">: 341/25S Lạc Long Quân, Phường Hoà Bình , TP. Hồ Chí Minh</td></tr><tr><td style="border: none; padding: 2px;">Mã số thuế</td><td style="border: none; padding: 2px;">: 0317726344</td></tr><tr><td style="border: none; padding: 2px;">Điện thoại</td><td style="border: none; padding: 2px;">: 0933 129 155</td></tr><tr><td style="border: none; padding: 2px;">Đại diện bởi</td><td style="border: none; padding: 2px;">: <b>Ông/Bà ${docData.safeFullName}</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Chức vụ: ${docData.safeRole}</td></tr><tr><td style="border: none; padding: 2px;">Tài khoản số</td><td style="border: none; padding: 2px;">: 305258 - Tại: Ngân hàng TMCP Á Châu - CN Ông Ích Khiêm</td></tr></table></div>
                <p><b>ĐIỀU 1: TÊN DỊCH VỤ - GIÁ TRỊ HỢP ĐỒNG</b></p>
                <table>
                    <tr><th style="width: 5%; border: 1px solid black; padding: 6px;">STT</th><th style="width: 35%; border: 1px solid black; padding: 6px;">SẢN PHẨM</th><th style="width: 15%; border: 1px solid black; padding: 6px;">BẢO HÀNH</th><th style="width: 10%; border: 1px solid black; padding: 6px;">ĐVT</th><th style="width: 15%; border: 1px solid black; padding: 6px;">ĐƠN GIÁ ()</th><th style="width: 5%; border: 1px solid black; padding: 6px;">SL</th><th style="width: 15%; border: 1px solid black; padding: 6px;">THÀNH TIỀN</th></tr>
                    ${tbodyHD}
